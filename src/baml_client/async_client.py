...
class BamlAsyncClient:
    ...
    async def ExtractQuestions(
        ...
        if "on_tick" in baml_options:
            ...
            stream = self.stream.ExtractQuestions(
    ...
    async def ExtractRenterProfile(
        self,
        conversation: str,
        baml_options: BamlCallOptions = {},
    ) -> types.CallerProfile:
        ...
        if "on_tick" in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.ExtractRenterProfile(
                conversation=conversation, baml_options=baml_options
            )
            return await stream.get_final_response()
        else:
...
class BamlStreamClient:
    ...
    def ExtractRenterProfile(
        ...
        conversation: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.CallerProfile, types.CallerProfile]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(
            function_name="ExtractRenterProfile",
            args={
                "conversation": conversation,
        ...
        return baml_py.BamlStream[stream_types.CallerProfile, types.CallerProfile](
            result,
            lambda x: typing.cast(
